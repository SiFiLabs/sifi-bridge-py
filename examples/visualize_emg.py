from sifi_bridge_py import SifiBridge, SifiDeviceNames
import logging
...
def main():
    device_type = SifiDeviceNames.BIOARMBAND
    ...
    emg_data = (
        ...
        if device_type == SifiDeviceNames.BIOARMBAND
        else {"emg": []}
    )
    base_key = "emg0" if device_type == SifiDeviceNames.BIOARMBAND else "emg"
